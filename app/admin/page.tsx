...
import { Lock, Shield, Unlock, Trash, Clock, ExternalLink, Settings, Home, Search, FileText, EyeOff, Flame, Link as LinkIcon, RefreshCw, Ghost, Database, Archive, File as FileIcon, Image as ImageIcon, Download, Activity, AlertTriangle, Check, Folder, MoreVertical, ArrowLeft } from "lucide-react";
        ...
        {adminTab === "dashboard" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4 mb-6">
              <button onClick={() => setAdminTab("landing")} className="p-2 hover:bg-white/10 rounded-full text-slate-400 hover:text-white transition"><ArrowLeft size={20} /></button>
              <h2 className="text-xl font-bold flex items-center gap-2 text-indigo-400"><Database size={24} /> Storage Metrics</h2>
            </div>
        ...
        {adminTab === "pads" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4 mb-8">
              <button onClick={() => setAdminTab("landing")} className="p-2 hover:bg-white/10 rounded-full text-slate-400 hover:text-white transition"><ArrowLeft size={20} /></button>
              <h2 className="text-xl font-bold flex items-center gap-2 text-purple-400"><FileText size={24} /> Pad Manager</h2>
            </div>
